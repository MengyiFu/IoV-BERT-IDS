...
def plot_confusion_matrix(cm,
    ...
    plt.savefig(savename,dpi=500)  # dpi分辨率
    # plt.show()


def plot_conf(y_pre, y_val, labels,label_value,savename):
    conf_mat = confusion_matrix(y_true=y_val, y_pred=y_pre,labels=label_value)
    print(conf_mat)
    plot_confusion_matrix(conf_mat, normalize=True, target_names=labels, title='Confusion Matrix',savename=savename)
